...
# from odoo.addons.edi import EDIMixin
from urllib import urlencode


SALE_QUOTATION_LINE_EDI_STRUCT = {
    'sequence': True,
    'name': True,
    #custom: 'date_planned'
    'product_id': True,
...
SALE_QUOTATION_EDI_STRUCT = {
    ...
    #custom: 'notes'
    'quotation_line': SALE_QUOTATION_LINE_EDI_STRUCT,
...
# class sale_quotation(osv.osv, EDIMixin):
#     _inherit = 'sale.quotation'
#
#     def edi_export(self, cr, uid, records, edi_struct=None, context=None):
#         """Exports a Sale quotation"""
#         edi_struct = dict(edi_struct or SALE_QUOTATION_EDI_STRUCT)
...
#             edi_doc = super(sale_quotation,self).edi_export(cr, uid, [order], edi_struct, context)[0]
#             edi_doc.update({
...
#
#         order_lines = edi_document['quotation_line']
...
#                 "item_name": order.company_id.name + " Quotation " + order.name,
#                 "invoice": order.name,
#                 "amount": order.amount_total,
#                 "currency_code": order.currency_id.name,
#                 "button_subtype": "services",
#                 "no_note": "1",
#                 "bn": "OpenERP_Quotation_PayNow_" + order.currency_id.name,
#             }
...
#
#
# class sale_quotation_line(osv.osv, EDIMixin):
...
#         edi_struct = dict(edi_struct or SALE_QUOTATION_LINE_EDI_STRUCT)
#         edi_doc_list = []
#         for line in records:
#             edi_doc = super(sale_quotation_line,self).edi_export(cr, uid, [line], edi_struct, context)[0]
